...
<div class="container-fluid app-body settings-page">
	...
	<div class="feedback_from">
		<p><strong>What type of stats are you interested in seeing? Let me know and I will see what I can do.</strong></p>
		<form id="send-idea">
		{{csrf_field()}}
			<input type="hidden" name="email" value="{{$user->email}}">
			<input type="hidden" name="sub" value="Bulkly analytics ideas">
